(function (window, undefined) {
    ...
    MapsLib.prototype.doSearch = function () {
        ...
        //-----custom filters-----
        var text_searchname = $("#text_searchname").val().replace("'", "\\'");
		if (text_searchname != '')
  			self.whereClause += " AND 'ComboName' contains ignoring case '" + text_searchname + "'"// AND not equal to 'Corporate Title' does not contain ignoring case '" + text_searchname + "'";
  			 //now it's only doing where both conditions are satisfied
  			 
  		var text_searchtype = $("#text_searchtype").val().replace("'", "\\'");
		if (text_searchtype != '')
  			self.whereClause += " AND 'ComboType' contains ignoring case '" + text_searchtype + "'"
  			
  		var text_searchtype = $("#text_searchgen").val().replace("'", "\\'");
		if (text_searchtype != '')
  			self.whereClause += " AND 'ComboAll' contains ignoring case '" + text_searchtype + "'"
  			
  		var text_searchtype = $("#text_searchcontact").val().replace("'", "\\'");
		if (text_searchtype != '')
  			self.whereClause += " AND 'ComboContact' contains ignoring case '" + text_searchtype + "'"
